...
def load(start_idx, end_idx, split):
    ...
    try:
        ...
        raw_file = os.path.join(SCRIPT_DIR, "dataxyz.csv")
        ...
        # np.save("features/features_array.npy", features_array)
        # return features_array
        
        with open("features/features_dataframe.pkl", "wb") as f:
            pickle.dump(df_single_subject, f)
        return df_single_subject   
